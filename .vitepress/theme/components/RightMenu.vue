    ...
    <Transition name="fade" mode="out-in">
      ...
      >
        ...
        >
          ...
          <!-- 更换图片 -->
          <div class="all-menu general">
            <div class="btn" @click="rightMenuFunc('change-background')">
              <i class="iconfont icon-genghuantupian"></i>
              <span class="name">更换背景图片</span>
            </div>
            <!-- 复制地址 -->
  ...
  try {
    ...
    switch (type) {
      ...
      case "change-background":
        // 更换背景图
        backgroundUrl.value = images[currentIndex];
        currentIndex = (currentIndex + 1) % Object.keys(images).length; // 循环索引
